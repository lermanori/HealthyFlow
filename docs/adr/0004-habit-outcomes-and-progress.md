...
Any progress or explicit outcome materializes the selected virtual Habit instance under ADR-0001. The target is copied from the parent at materialization so recorded history stays frozen. The legacy `completed` boolean remains a compatibility mirror and is true only for the completed outcome.
