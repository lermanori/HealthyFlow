  ...
  return (
    <div className="card ai-glow">
      <div className="flex items-center space-x-3 mb-4">
        <div className="w-6 h-6 bg-action rounded-lg flex items-center justify-center">
          <TrendingUp className="w-3 h-3 text-white" />
        </div>
        <h3 className="text-lg font-semibold text-ink">Weekly Progress</h3>
        <Sparkles className="w-4 h-4 text-accent animate-neon-flicker" />
      </div>
            ...
            <div key={day.date.toISOString()} className="flex items-end space-x-3">
              ...
              <div className="flex-1 relative">
                <div className="flex items-end space-x-1">
                  {/* Total tasks bar */}
                  <div 
                    className="relative bg-raised/50 rounded-t w-8 border border-line-strong/50" 
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-accent to-action rounded-t"
                    />
                    ...
                    <motion.div
                      ...
                      transition={{ delay: index * 0.1, duration: 0.5 }}
                      className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-accent to-action rounded-t blur-sm"
                    />
                  </div>
      ...
      <div className="mt-6 flex items-center justify-between text-xs text-ink-muted pt-4 border-t border-line/50">
        <span className="text-ink-muted font-medium">This Week</span>
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-raised rounded border border-line-strong"></div>
            <span className="text-ink-muted">Total</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-action rounded"></div>
