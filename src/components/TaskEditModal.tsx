            ...
            <div className="flex-1 overflow-y-auto">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {isHabit && editScope === 'habit' && <div className="space-y-3 rounded-xl border border-purple-500/25 bg-purple-500/5 p-4">
                  <div><p className="text-sm font-medium text-ink-soft">Habit tracking</p><p className="mt-1 text-xs text-ink-muted">Changes apply to future unrecorded days.</p></div>
